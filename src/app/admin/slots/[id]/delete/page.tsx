import { Container, Title, Card, Button, Group, Stack, Text, Alert, Badge } from '@mantine/core';
    ...
    <Container size="md">
      <Stack gap="lg">
        ...
        <Card shadow="sm" padding="xl" radius="md" withBorder>
          <Stack gap="lg">
            <div>
              <Title order={1} color="red">Delete Slot</Title>
            ...
            <Alert 
              ...
              variant="light"
            >
              This action cannot be undone. All data associated with this slot will be permanently deleted.
            </Alert>
              ...
              <Stack gap="md">
                ...
                {slot.registrations.length > 0 && (
                  <Alert 
                    ...
                    variant="light"
                  >
                    This slot has {slot.registrations.length} active registration(s). 
                    Deleting this slot will also remove all associated registrations.
                  </Alert>
                )}
              </Stack>
            </Card>
